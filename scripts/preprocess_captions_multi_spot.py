...
parser.add_argument('--input_captions_json', default="./spot-the-diff/change_multi_captions.json", help='input captions json file to process into hdf5')
parser.add_argument('--input_image_dir', default="./spot-the-diff/images", help='input image directory')
parser.add_argument('--input_vocab_json', default='')
parser.add_argument('--split_json', default="./spot-the-diff/splits.json", help='json file that contains the dataset splits')
parser.add_argument('--output_vocab_json', default="./spot-the-diff/transformer_multi_vocab.json", help='output vocab file')
parser.add_argument('--output_h5', default="./spot-the-diff/transformer_multi_labels.h5", help='output h5 file')
...
def main(args):
    ...
    for i, img in enumerate(all_imgs):
        idx = int(os.path.splitext(img)[0].split('_')[-1])
        if i != idx:
           all_imgs.insert(i, 'none')
    all_captions = []
