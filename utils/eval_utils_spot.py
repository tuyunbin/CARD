...
if __name__ == '__main__':
    anno_path = '/data1/yunbin_tu/acl23/spot-the-diff/change_multi_captions.json'
    coco_gt_format_save(anno_path)


    save_path = '/data1/yunbin_tu/acl23/spot-the-diff/change_multi_captions_reformat.json'
